...
ap.add_argument("-o", "--output", default= "output/image.jpg",
	help="path to input image")
...
# load class labels our YOLO model was trained on
...
classIDs = []
classname = []
list_of_vehicles = ["car","cyclist","bus","minibus","truck"]
...
cv2.putText(image, "total: " + str(total_vehicles), (50,50), cv2.FONT_HERSHEY_SIMPLEX,
			0.5, color, 2)
